...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // highBtn = findViewById(R.id.btn_High);
        ...
        Log.i("TEST", " before onCheckedChanged: add priority");
        ...
        priorityGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Log.i("TEST", "onCheckedChanged: add priority");
            }
        });


        Log.i("TEST", "onClick: "+ "priority="+ priority[0]);
    ...
    private boolean saveNote2Database(String content,int priority) {
        ...
        Log.i("TEST", "saveNote2Database: "+"add priority:" + priority + " success");

        long newRowID = db.insert(TodoContract.TodoList.TABLE_NAME,null,values);
        Log.i("TEST", "saveNote2Database: "+ newRowID);
        if(newRowID < 0)
            return false;
        else
            return true;
