...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("TEST", "onCreate: get intent:n" + uri);
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                if (isTouch){
                    ...
                    if (myvideoView != null) {
                        ...
                        Log.d("TEST", "onProgressChanged: "+process+"-----"+myvideoView.getDuration()+"____"+process * myvideoView.getDuration() / 100 );
                    }
                }
        ...
        Log.d("TEST", "onCreate: uri is:" + uri);
        ...
        myvideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mediaPlayer) {
                ...
                Log.d("TEST", "onPrepared: get all time :" + msecToTime(time_all));
    ...
    public void onConfigurationChanged(Configuration newConfig){
        ...
        if (screenOritentation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            Log.d("TEST", "onConfigurationChanged: 竖屏");
        } else {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.MATCH_PARENT);
            params.addRule(RelativeLayout.CENTER_IN_PARENT);
            myvideoView.setLayoutParams(params);
            Log.d("TEST", "onConfigurationChanged: 横屏");
        }
    }
